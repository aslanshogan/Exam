...
--
-- =====================================================================
-- v4.21 — EDITABLE TRAINER/GENERATOR TOPICS
-- =====================================================================
-- Lets admins manage the AI topic list (add/rename/delete/reorder/regroup)
-- from the UI instead of code. Safe to re-run.
...
create index if not exists idx_trainer_topics_order on trainer_topics(group_name, sort_order);

alter table trainer_topics disable row level security;
grant all privileges on table trainer_topics to service_role;
