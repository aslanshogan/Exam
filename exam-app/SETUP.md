...
Super Admins with a username exist. If you expected it and see normal
login instead, an admin already exists — log in as them. If you see it
unexpectedly on an established deployment, your super admin was
blocked or lost their username — restore via SQL:
